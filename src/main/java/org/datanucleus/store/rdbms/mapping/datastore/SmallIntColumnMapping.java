...
{
    public SmallIntColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public void setObject(PreparedStatement ps, int param, Object value)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    throw new NucleusException("SmallIntColumnMapping.setObject called for " + StringUtils.toJVMIDString(value) + " but not supported");
                }
            }
        }
        catch (SQLException e)
