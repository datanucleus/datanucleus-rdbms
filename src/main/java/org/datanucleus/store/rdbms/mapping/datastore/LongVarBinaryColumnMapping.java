 ...
 */
public class LongVarBinaryColumnMapping extends AbstractLargeBinaryColumnMapping
{
    /**
     * Constructor.
     ...
     * @param col Column
     */
    public LongVarBinaryColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
