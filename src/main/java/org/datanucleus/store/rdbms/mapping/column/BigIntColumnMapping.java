...
public class BigIntColumnMapping extends AbstractColumnMapping
{
     ...
     * @param col Column
     */
    public BigIntColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    /*
     * (non-Javadoc)
     * @see org.datanucleus.store.rdbms.mapping.column.AbstractColumnMapping#setString(java.lang.Object, int,
     * java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.datanucleus.store.rdbms.mapping.column.AbstractColumnMapping#getString(java.lang.Object, int)
     */
    @Override
