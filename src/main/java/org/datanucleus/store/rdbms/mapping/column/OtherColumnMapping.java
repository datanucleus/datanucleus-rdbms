 ...
 */
public class OtherColumnMapping extends AbstractColumnMapping
{
    public OtherColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    /* (non-Javadoc)
     * @see org.datanucleus.store.rdbms.mapping.column.AbstractColumnMapping#setObject(java.sql.PreparedStatement, int, java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.datanucleus.store.rdbms.mapping.column.AbstractColumnMapping#getObject(java.sql.ResultSet, int)
     */
    @Override
