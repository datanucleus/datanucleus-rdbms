 ...
 * <ul>
 * <li>Serialise the field into the BLOB using ObjectOutputStream, and deserialise it back using ObjectInputStream</li>
...
public class BlobColumnMapping extends AbstractLargeBinaryColumnMapping
{
    ...
    /*
     * (non-Javadoc)
     * @see org.datanucleus.store.rdbms.mapping.AbstractLargeBinaryColumnMapping#getObject(java.lang.Object,
     * int)
     */
    @Override
