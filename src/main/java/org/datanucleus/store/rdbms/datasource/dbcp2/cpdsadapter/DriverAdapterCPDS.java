...
import org.datanucleus.store.rdbms.datasource.dbcp2.DelegatingPreparedStatement;
import org.datanucleus.store.rdbms.datasource.dbcp2.PStmtKey;
import org.datanucleus.store.rdbms.datasource.dbcp2.Utils;
...
import org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericKeyedObjectPool;
 ...
 * <code>Connection</code>s, such as {@link org.datanucleus.store.rdbms.datasource.dbcp2.datasources.SharedPoolDataSource}. A J2EE container
...
public class DriverAdapterCPDS implements ConnectionPoolDataSource, Referenceable, Serializable, ObjectFactory {
     ...
     * <p>
     * When a negative value is supplied, <i>ceil({*link #numIdle})/abs({*link #getNumTestsPerEvictionRun})</i> tests
