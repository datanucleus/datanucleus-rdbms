...
public final class PoolUtils {
    ...
    public static <K, V> KeyedObjectPool<K, V> synchronizedPool(final KeyedObjectPool<K, V> keyedPool) {
         ...
         * !"org.datanucleus.store.rdbms.datasource.dbcp2.pool.composite.CompositeKeyedObjectPool"
    ...
    public static <T> ObjectPool<T> synchronizedPool(final ObjectPool<T> pool) {
         ...
         * !"org.datanucleus.store.rdbms.datasource.dbcp2.pool.composite.CompositeObjectPool"
