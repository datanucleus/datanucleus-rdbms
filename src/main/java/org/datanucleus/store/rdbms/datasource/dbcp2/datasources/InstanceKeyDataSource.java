...
import org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.BaseObjectPoolConfig;
import org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericKeyedObjectPoolConfig;
...
public abstract class InstanceKeyDataSource
    ...
    */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each
     * per user pool.
     */
    ...
    /**
     * Sets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnCreate()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnBorrow()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnReturn()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getTestWhileIdle()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool GenericObjectPool#getTimeBetweenEvictionRunsMillis ()} for each
     * per user pool.
     */
