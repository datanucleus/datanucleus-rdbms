 ...
 *
 * <p>
 * The dbcp package contains an adapter, {@link org.datanucleus.store.rdbms.datasource.dbcp2.cpdsadapter.DriverAdapterCPDS}, that can be
...
public abstract class InstanceKeyDataSource implements DataSource, Referenceable, Serializable, AutoCloseable {
    ...
    /**
     * Gets the default value for {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool
     * GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     *
     * @return The default value for {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool
     *         GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     */
    ...
    /**
     * Sets the default value for {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool
     * GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     *
     * @param softMinEvictableIdleTimeMillis
     *            The default value for {@link org.datanucleus.store.rdbms.datasource.dbcp2.pool2.impl.GenericObjectPool
     *            GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     */
