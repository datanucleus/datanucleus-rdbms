...
public class SAPDBAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadDatastoreMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerDatastoreMapping(Long.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.DecimalColumnMapping.class, JDBCType.DECIMAL, "NUMERIC", true);
        ...
        registerDatastoreMapping(Long.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.DoubleColumnMapping.class, JDBCType.DOUBLE, "DOUBLE", false);
        ...
        registerDatastoreMapping(BigInteger.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.DecimalColumnMapping.class, JDBCType.DECIMAL, "NUMERIC", true);
