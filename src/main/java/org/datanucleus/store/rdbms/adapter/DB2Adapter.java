...
public class DB2Adapter extends BaseDatastoreAdapter
{
    ...
    public void loadDatastoreMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerDatastoreMapping(Float.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.RealRDBMSMapping.class, JDBCType.REAL, "REAL", true);
        ...
        registerDatastoreMapping(String.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.DB2DatalinkRDBMSMapping.class, JDBCType.DATALINK, "DATALINK", false);
