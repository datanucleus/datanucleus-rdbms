...
public class DB2Adapter extends BaseDatastoreAdapter
{
    ...
    protected void loadColumnMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerColumnMapping(Float.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.RealColumnMapping.class, JDBCType.REAL, "REAL", true);
        ...
        registerColumnMapping(String.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.DB2DatalinkColumnMapping.class, JDBCType.DATALINK, "DATALINK", false);
