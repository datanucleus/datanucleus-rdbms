...
public class DerbyAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadColumnMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerColumnMapping(String.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.SqlXmlColumnMapping.class, JDBCType.SQLXML, "XML", false);
        ...
        registerColumnMapping(java.io.Serializable.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.BinaryColumnMapping.class, JDBCType.BINARY, "CHAR () FOR BIT DATA", false);
        ...
        registerColumnMapping(byte[].class.getName(), org.datanucleus.store.rdbms.mapping.datastore.BinaryColumnMapping.class, JDBCType.BINARY, "CHAR () FOR BIT DATA", false);
