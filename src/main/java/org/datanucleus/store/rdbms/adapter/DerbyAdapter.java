...
public class DerbyAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadDatastoreMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerDatastoreMapping(String.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.SqlXmlColumnMapping.class, JDBCType.SQLXML, "XML", false);
        ...
        registerDatastoreMapping(java.io.Serializable.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.BinaryColumnMapping.class, JDBCType.BINARY, "CHAR () FOR BIT DATA", false);
        ...
        registerDatastoreMapping(byte[].class.getName(), org.datanucleus.store.rdbms.mapping.datastore.BinaryColumnMapping.class, JDBCType.BINARY, "CHAR () FOR BIT DATA", false);
