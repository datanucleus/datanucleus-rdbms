...
public class TimesTenAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadColumnMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerColumnMapping(java.io.Serializable.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.TimesTenVarBinaryColumnMapping.class, JDBCType.VARBINARY, "VARBINARY", true);
        ...
        registerColumnMapping(byte[].class.getName(), org.datanucleus.store.rdbms.mapping.datastore.TimesTenVarBinaryColumnMapping.class, JDBCType.VARBINARY, "VARBINARY", true);
