...
public class PostgreSQLAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadDatastoreMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerDatastoreMapping(java.util.Collection.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.ArrayColumnMapping.class, JDBCType.ARRAY, "TEXT ARRAY", false);
        registerDatastoreMapping(java.util.Collection.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.ArrayColumnMapping.class, JDBCType.ARRAY, "INT ARRAY", false);
