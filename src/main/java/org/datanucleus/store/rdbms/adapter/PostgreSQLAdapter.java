...
public class PostgreSQLAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadDatastoreMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerDatastoreMapping(String.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.SqlXmlRDBMSMapping.class, JDBCType.SQLXML, "SQLXML", false);
        ...
        registerDatastoreMapping(java.util.Collection.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.ArrayRDBMSMapping.class, JDBCType.ARRAY, "TEXT ARRAY", false);
        registerDatastoreMapping(java.util.Collection.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.ArrayRDBMSMapping.class, JDBCType.ARRAY, "INT ARRAY", false);
