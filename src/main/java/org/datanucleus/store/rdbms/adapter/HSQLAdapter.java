...
public class HSQLAdapter extends BaseDatastoreAdapter
{
    ...
    protected void loadColumnMappings(PluginManager mgr, ClassLoaderResolver clr)
    {
        ...
        registerColumnMapping(Boolean.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.BooleanColumnMapping.class, JDBCType.BOOLEAN, "BOOLEAN", true);
        ...
        if (datastoreMajorVersion >= 2)
        {
            ...
            registerColumnMapping(Float.class.getName(), org.datanucleus.store.rdbms.mapping.datastore.FloatColumnMapping.class, JDBCType.FLOAT, "FLOAT", false);
