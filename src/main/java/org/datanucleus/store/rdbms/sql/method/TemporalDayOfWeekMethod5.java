 ...
 * Returns a NumericExpression that equates to <pre>strftime("%w", expr)+1</pre>
 */
public class TemporalDayOfWeekMethod5 extends TemporalBaseMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List<SQLExpression> args)
    {
        ...
        NumericExpression numExpr = new NumericExpression(new NumericExpression(stmt, getMappingForClass(int.class), "strftime", funcArgs), Expression.OP_ADD, one);
