 ...
 */
public class TemporalMonthMethod4 extends TemporalBaseMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List<SQLExpression> args)
    {
        ...
        NumericExpression numExpr = new NumericExpression(stmt, getMappingForClass(int.class), "strftime", funcArgs);
