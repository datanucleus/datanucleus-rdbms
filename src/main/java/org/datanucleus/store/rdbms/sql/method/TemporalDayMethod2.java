 ...
 */
public class TemporalDayMethod2 extends TemporalBaseMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLStatement stmt, SQLExpression expr, List<SQLExpression> args)
    {
        ...
        List<SQLExpression> funcArgs = List.of(invokedExpr, stmt.getSQLExpressionFactory().newLiteral(stmt, mapping, "DD"));
