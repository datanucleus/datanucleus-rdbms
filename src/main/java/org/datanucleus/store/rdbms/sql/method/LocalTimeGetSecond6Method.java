...
/**
 * Method for evaluating {localtimeExpr}.getSecond() using SQLite.
 * Returns a NumericExpression that equates to <pre>strftime("%S", expr)</pre>
 */
public class LocalTimeGetSecond6Method extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        SQLExpression ss = exprFactory.newLiteral(stmt, mapping, "%S");
