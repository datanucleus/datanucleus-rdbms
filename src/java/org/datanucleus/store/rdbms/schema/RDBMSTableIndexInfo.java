...
public class RDBMSTableIndexInfo implements ListStoreSchemaData
{
    ...
    /**
     * Indicates whether some object is "equal to" this one. Two <tt>RDBMSTableIndexInfo</tt> are considered
    ...
    {
        StringBuffer str = new StringBuffer("RDBMSTableIndexInfo : ");
        ...
        str.append(", numIndices=" + indices.size());
        return str.toString();
    }
}